...
function RubCardLayer:create(szBack, szFontBlank, szFont, posX, posY, isRotaion90, endCallBack)
    local layer = EJExtendUserData(RubCardLayer, cc.Layer:create())
    self.__index = self
    layer:__init(szBack, szFontBlank, szFont, posX, posY, endCallBack)
    return layer
end

function RubCardLayer:__init(szBack, szFontBlank, szFont, posX, posY, isRotaion90, endCallBack)
    self.posX        = posX
    self.posY        = posY
