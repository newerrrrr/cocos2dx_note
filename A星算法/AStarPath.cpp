...
{
    _openSize = 0;
    memset(_OPEN_LIST, 0, _mapWidth*_mapHeight+1);
    
    _CLOSE_LIST.clear();
    _CLOSE_LIST.reserve(_mapWidth*_mapHeight+1);
...
*/
    ...
    CCLOG("-- isWalkable: %d, %d", grid_x, grid_y);
    int result = 0;
    ...
    {        
        ...
        lua_newtable(L);
        tolua_pushnumber(L, (lua_Number)grid_x);
